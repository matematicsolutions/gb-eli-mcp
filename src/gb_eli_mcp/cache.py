...
- acts (single-act metadata): 24h
- lists/search: 1h
- dictionaries (publishers/statistics): 7 days
- recent changes: 5 min (this data must be fresh)

Inherited verbatim from sejm-eli-mcp (only the env var and cache dir differ).
"""
